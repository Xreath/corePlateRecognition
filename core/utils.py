...
def recognize_plate_easy(img, coords):
    ...
    for i in range(num_boxes):
        ...
        if class_name not in allowed_classes:
            ...
            if read_plate:
                ...
                plate_number = recognize_plate_easy(image, coor)
            ...
            coord = np.array([(c1[0] + c2[0]) / 2, (c1[1] + c2[1]) / 2])
            center_arry.append(coord)
            ...
            if show_label:
                ...
                cv2.circle(image, tuple((coord.astype(int))), 5, (255, 0, 0), -1)
