...
flags.DEFINE_string('weights', 'yolov4-tiny-416',
    ...
    while True:
        ...
        if FLAGS.crop:
            ...
            try:
                ...
                pass
            if (frame_num % crop_rate == 0) & (pred_bbox[0][0][0] != 0):
        ...
        if FLAGS.count:
            ...
            image, center_arry = utils.draw_bbox(frame, pred_bbox, FLAGS.info, allowed_classes=allowed_classes,read_plate=FLAGS.plate) #sdsadsadddawssdasdsasad
        ...
        #result = imutils.resize(result, 640)
